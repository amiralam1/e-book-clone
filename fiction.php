...
<body>
            ...
            <div class="left-container">
                <div class="content">
                    <div class="hero-heading">
                        <h1>Fiction Ghostwriting</h1>
                        <!-- <h1>Ghostwriting and Editing </h1> -->
                        <h1>Services </h1>
                    </div>
                    <div class="hero-content">
                        <p>Work with New York Times-bestselling writers and editors from Big-5 publishers to write your novel and reach your readers. </p>
                    </div>
        ...
        <div class="bestselling-books">
            ...
            <div class="bookCard-container">
                ...
                <div class="book-content">
                    <p>New York Times bestseller, 100K+ sold</p>
                </div>
            </div>
            <div class="bookCard-container">
                <div class="book-img" style="width: 220px;">
                    <img src="Assets/Images/Bar-Maid-800x1074.png" alt="">
                </div>
                <div class="book-content">
                    <p>USA TODAY bestseller</p>
                </div>
            </div>
            <div class="bookCard-container" style="width: auto;">
                <div class="book-img" id="book-img1" style=" width: 370px;">
                    <img src="Assets/Images/The-Silver-Eyes-Five-Nights-At-Freddys-1-800x635.png" alt="">
                </div>
                <div class="book-content" id="book-content1" style="width: 140%;">
                    <p>#1
                        New York Times bestseller, million+ sold</p>
                </div>
            </div>
            <!-- <div class="bookCard-container">
                <div class="book-img">
        ...
        <div class="team-membercards">
            <div class="member-card">
                ...
                <div class="member-books">
                    <img src="Assets/Images/THE-LAKE-OF-DREAMS-1.png" alt="">
                    <img src="Assets/Images/IN-THE-WOODS_-1.png" alt="">
                    <img src="Assets/Images/THE-SLEEPWALKERS-GUIDE-TO-DANCING-1.png" alt="">
                </div>
            </div>
            <div class="member-card">
                <div class="member-description">
                ...
                <div class="member-books">
                    <img src="Assets/Images/RASPUTINS-DAUGHTER-1.png" alt="">
                    <img src="Assets/Images/THE-TESTAMENT-OF-GIDEON-MACK.png" alt="">
                    <img src="Assets/Images/LAPD53.png" alt="">
                </div>
            </div>
            <div class="member-card">
                <div class="member-description">
                ...
                <div class="member-books">
                    <img src="Assets/Images/The-Ares-Decision-by-Kyle-Mills-from-The-Estate-of-Robert-Ludlum_-800x1074.png" alt="">
                    <img src="Assets/Images/The-Double-O-Section-Double-or-Nothing-by-Kim-Sherwood-from-The-Estate-of-Ian-Fleming-1-800x1074.png" alt="">
                    <img src="Assets/Images/The-Fall-of-Gondolin-from-The-Estate-of-J.R.R.-Tolkien_-800x1074.png" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="columns">
            ...
            <div class="wcu-right-col">
                ...
                <div class="row benefits-row-item">
                    ...
                    <p> Our work includes countless award-winning and #1 New York Times- bestselling books. Leading publishers and agents hire KAA to write books for their authors.
                    </p>
                </div>
                ...
                <div class="row benefits-row-item">
                    ...
                    <p> Work with the best talent in the industry. Our team includes #1 New York Times-bestselling fiction ghostwriters.
                    </p>
                </div>
                ...
                <div class="row benefits-row-item">
                    ...
                    <p> We’ll develop a customized publishing strategy and guide you through every step of the process to ensure your novel lands with the right publisher.
                    </p>
                </div>
        ...
        <div class="columns reversed">
            ...
            <div class="wcu-right-col">
                <div class="row benefits-row-item2">
                    <h2>Big-5 Editors</h2>
                    <p>
                        Your project will be overseen by an editor who has held senior positions at Big-5 publishers, has deep knowledge of the publishing landscape, and has produced numerous bestselling titles.
                ...
                <div class="row benefits-row-item2">
                    ...
                    <p>
                        Brainstorming, concept creation, outlining, writing, revisions, editing, beta testing, marketing and PR strategy, agent acquisition, publishing strategy, and more.
                    </p>
                </div>
                <div class="row benefits-row-item2">
                    <h2>Agent and Publisher Connections</h2>
                    <p>
                        Our clients include literary agents and publishers who specialize in fiction, offering you unparalleled access to the industry. While not every novel is the right fit for a traditional publisher, we regularly secure deals for our clients
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="sh-topics-wrapper">
        <div class="sh-content-container">
            <div class="sh-heading">Our Nonfiction Ghostwriting Services By Genre</div>
            <div class="sh-list">
    ...
    <section class="kaa">
        ...
        <div class="text">
            <p>
                The worst novels are the ones that go unwritten.
            </p>
        </div>
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div class="accordion-item faq-accordion-item-custom">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">Absolutely! Your ghostwriter can be intimately involved with the planning and development of your concept, and they can also perform in-depth research to augment and elaborate on your topic. We can conduct interviews with you and create an outline for your book based on your ideas that you can then refine and expand with your writer before the process begins.</div>
                        </div>
                    </div>
                    <div class="accordion-item faq-accordion-item-custom">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">Our comprehensive ghostwriting service provides you with an experienced team of professional writers, editors, and publishing experts who work collectively to write a publish-worthy book. You can read about our general process here; we are happy to personalize our process to your preferences and provide you with a detailed proposal.
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample2">
                    ...
                    <div class="accordion-item faq-accordion-item-custom">
                        ...
                        <div id="flush-collapse16" class="accordion-collapse collapse" aria-labelledby="flush-heading16" data-bs-parent="#accordionFlushExample2">
                            <div class="accordion-body">Absolutely! The most important elements behind ghostwriting are the ideas—and as the author and initiator of your book, the ideas are all yours. The fact is that some people are just too busy or lack the writing skills to develop a publishable book—but their voices still deserve to be heard. A ghostwriter facilitates this process and acts as a translator between your mind and what readers can understand and enjoy. The ghostwriting process is simply a means for getting your story into the world!</div>
                        </div>
                    </div>
                    <div class="accordion-item faq-accordion-item-custom">
