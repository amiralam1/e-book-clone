...
<body>
        ...
        <div class="content-container">
            <div class="left-container">
                <div class="content">
                    <div class="hero-heading">
                        <h1>Nonfiction Ghostwriting</h1>
                        <!-- <h1>Ghostwriting and Editing </h1> -->
                        <h1>Services </h1>
                    </div>
                    <div class="hero-content">
                        <p>Become a published author with the help of bestselling ghostwriters and Big-5 editors </p>
                    </div>
            ...
            <div class="right-container">
                <div class="image-grid">
                    ...
                    <div class="grid-item">
                        <img src="Assets/Images/The-Wim-Hof-Method-1.webp" alt="Image 1">
                    </div>


                    <div class="grid-item">
                        <img src="Assets/Images/body-reset-diet-800x1074.png" alt="Image 2">
                        <img src="Assets/Images/You-Are-a-Badass.png" alt="Image 3">
                    </div>


                    <div class="grid-item">
                        <img src="Assets/Images/Daring-Greatly.webp" alt="Image 4">
                        <img src="Assets/Images/happy-money@2x.webp" alt="Image 5">
                    </div>


                    <div class="grid-item">
                        <img id="bk-img-grid-last" src="Assets/Images/Dunder-Mifflin-1-800x1075.webp" alt="Image 6">
    ...
    <section class="team-wrapper">
        ...
        <div class="team-membercards">
            ...
            <div class="member-card">
                ...
                <div class="member-books">
                    <img src="Assets/Images/Live-Long-and-What-I-Learned-Along-the-Way.png" alt="" style="width: 168px;">
            ...
            <div class="member-card">
                ...
                <div class="member-books">
                    ...
                    <img src="Assets/Images/Brothers-in-Arms-The-Epic-Story-of-the-761st-Tank-Battalion-WWIIs-Forgotten-Heroes-800x1074.png" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="columns">
            ...
            <div class="wcu-right-col">
                ...
                <div class="row benefits-row-item">
                    ...
                    <p> Work with New York Times-bestselling nonfiction writers who can transform your concept and ideas into a powerful book.
                    </p>
                </div>

                <div class="row benefits-row-item">
                    <h2>Big-5 Acquisitions Editors</h2>

                    <p> Your project will be managed and edited by a former acquisitions editor from a Big-5 publisher with numerous New York Times bestselling titles.
                    </p>
                </div>

                <div class="row benefits-row-item">
                    <h2>Personalized Ghostwriting</h2>

                    <p> Every idea, every author, and every subject is unique. We build a team that knows your target audience, understands your subject matter, and can capture your individual voice.
                    </p>
                </div>
        ...
        <div class="sh-content-container">
            ...
            <div class="sh-list">
                <ul class="custom-list">
                    ...
                    <li> History and historical nonfiction</li>
                    <li> Textbooks</li>
                    <li> Health and wellness</li>
                    <li> Politics</li>
                </ul>
                <ul class="custom-list">
                    <li>Essay collections</li>
                    <li>Speeches and professional presentations</li>
                    <li>Travel writing and guides</li>
                    <li>Prescriptive and narrative nonfiction</li>
    ...
    <section class="kaa">
        <div class="heading">
            <h2>Let’s write your book and get it <br>published</h2>
        </div>
        <div class="text">
            <p>
                Work with our team of bestselling ghostwriters and editors to transform your ideas<br> into a nonfiction book that finds its place on the shelf.
            </p>
        </div>
        ...
        <div class="text">
            <p>
                Not sure where to start? Call us! If you have a story outline or even just an idea you <br> can’t get out of your head, we’re happy to discuss<br> your concept and advise you on the best path forward.
            </p>
        </div>
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample2">
                    <div class="accordion-item faq-accordion-item-custom">
                        ...
                        <div id="flush-collapse15" class="accordion-collapse collapse" aria-labelledby="flush-heading15" data-bs-parent="#accordionFlushExample2">
                            <div class="accordion-body">Yes, absolutely. The book we write for you will always be 100% your book. No one will ever know that you had professional help with the writing process unless you choose to tell them.</div>
                        </div>
                    </div>
                    <div class="accordion-item faq-accordion-item-custom">
                    ...
                    <div class="accordion-item faq-accordion-item-custom">
                        ...
                        <div id="flush-collapse13" class="accordion-collapse collapse" aria-labelledby="flush-heading13" data-bs-parent="#accordionFlushExample2">
                            <div class="accordion-body">The internet is littered with online writing and editing services, making it nearly impossible to sift through the scams and find a legitimate and trustworthy service. Here are some questions to ask when you’re vetting companies to ensure that you pick a reliable firm for all your writing and editing needs:
                                ...
                                2. Who owns the rights to the book? It’s your book, which means you should own the rights to your content. Be wary of ghostwriters asking for partial rights to your material.<br><br>
