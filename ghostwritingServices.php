...
<body>
            ...
            <div class="left-container">
                <div class="content">
                    <div class="hero-heading">
                        <h1>Professional</h1>
                        <h1>Ghostwriting Services by </h1>
                        <h1>NYT-Bestselling Writers</h1>
                    </div>
                    <div class="hero-content">
                        <p>Trust a team of <b>bestselling writers</b> and <b>Big-5 editors</b> to ghostwrite your book and achieve your publishing goals through book writing, editing, and </p>
                    </div>
            ...
            <div class="right-container">
                <div class="image-grid">
                    ...
                    <div class="grid-item">
                        ...
                        <img src="Assets/Images/The-Wim-Hof-Method-1.webp" alt="Image 3">
                    </div>


                    <div class="grid-item">
                        <img src="Assets/Images/Dunder-Mifflin-1-800x1075.webp" alt="Image 4">
                        <img src="Assets/Images/IN-THE-WOODS_-1.png" alt="Image 5">
                    </div>


                    <div class="grid-item">
                        <img id="bk-img-grid-last" src="Assets/Images/the-silver-eyes@2x.webp" alt="Image 6">
    ...
    <section class="bestselling-wrapper">
        ...
        <div class="bestselling-books">
            ...
            <div class="bookCard-container">
                <div class="book-img">
                    <img src="Assets/Images/the-silver-eyes.png" alt="">
                </div>
                <div class="book-content">
            ...
            <div class="author-container">
                ...
                <div class="author-card">
                    ...
                    <div class="author-description">
                        <h3>Tom Golisano</h3>
                        <p>Self-made billionaire, founder of Paychex, and author of the #1 national bestseller,<span class="underline"><a href="#"><em>Built, Not Born</em></a> </span></p>
                    </div>
                </div>
            </div>
            <div class="author-container">
                ...
                <div class="author-card">
                    ...
                    <div class="author-description">
                        ...
                        <p>Author of New York Times bestseller,<span class="underline"><a href="#"> <em> Welcome to Dunder Mifflin: The Ultimate Oral History of The Office</em></a></span></p>
                    </div>
                </div>
            </div>
            <div class="author-container">
                ...
                <div class="author-card">
                    ...
                    <div class="author-description">
                        <h3>Scott Cawthon</h3>
                        <p>#1 <span class="underline"><a href="#"><em>New York Times-bestselling author</em></a> </span>, Over 1 million copies sold!</p>
                    </div>
                </div>
            </div>
    </section>
    ...
    <section class="team-wrapper">
        <div class="team-heading">
            <p>Meet Your Bestselling Writing & Editing Team</p>
            <hr>
        </div>
        <div class="team-membercards">
            ...
            <div class="member-card">
                ...
                <div class="member-books">
                    <img src="Assets/Images/The-One-Minute-Entrepreneur-The-Secret-to-Creating-and-Sustaining-a-Successful-Business-800x1074.png" alt="">
    ...
    <section class="gw-services-genre-wrapper">
        <div class="services-genre-container">
            <div class="services-heading-card">
                <h2>Ghostwriting <br> Services by Genre</h2>
            </div>
            <div class="services-genre-card bg-lightblue autobiography">
                <h3>Memoir & Autobiography</h3>
                <p>Work with writers who can develop the moments of your life into a page-turning book.</p>
                <p id="more" class="gw-readmore">Read More</p>
            </div>
            <div class="services-genre-card selfhelp">
                <h3>Self-Help Books</h3>
                <p>Share your expertise or life lessons with a powerful book.</p>
                <p id="more" class="gw-readmore">Read More</p>
            </div>
            <div class="services-genre-card bg-lightblue business">
                <h3>Business Books</h3>
                <p>Establish yourself as a thought leader or enjoy the ROI that a book can generate for your business.</p>
                <p id="more" class="gw-readmore">Read More</p>
            </div>
            <div class="services-genre-card bg-lightblue fiction">
                <h3>Fiction</h3>
                <p>Our team of bestselling novelists and award-winning writers can turn your creative concept into a publish-worthy manuscript.</p>
                <p id="more" class="gw-readmore">Read More</p>
            </div>
            <div class="services-genre-card nonfiction">
                <h3>Nonfiction</h3>
                <p>Work with an experienced book-writing team that knows how to break out big nonfiction titles.</p>
                <p id="more" class="gw-readmore">Read More</p>
            </div>
            <div class="services-genre-card bg-lightblue book-proposal-btn">
                <h3>Article Writing</h3>
                <p>Make yourself visible and expand your authority with articles, blog posts, and SEO content.</p>
                <p id="more" class="gw-readmore">Read More</p>
            </div>
            <div class="services-genre-card childrens-books">
                <h3>Children’s Books</h3>
                <p>Work with New York Times #1-bestselling children’s book authors to transform your idea into its final form.</p>
                <p id="more" class="gw-readmore">Read More</p>
            </div>
        </div>
    </section>
        ...
        <div class="gw-experience-container">
            <div class="experience-content">
                <div class="experience-content-heading">
                    <h1>The KAA Ghostwriting Experience</h1>
                    <hr>
                </div>
                ...
                <div class="container my-5">
                    <div class="accordion-item" id="accordion-item-1">
                        ...
                        <label class="accordion-header" for="accordion1">
                            ...
                            <span class="accordion-title"> Complimentary Author Consultation</span>
                    ...
                    <div class="accordion-item">
                        ...
                        <label class="accordion-header" for="accordion3">
                            ...
                            <span class="accordion-title">
                                Meet Your Book-Writing Team</span>
                            <span class="accordion-sign"></span>
                        </label>
                        <div class="accordion-content">
                    ...
                    <div class="accordion-item">
                        ...
                        <label class="accordion-header" for="accordion4">
                            ...
                            <span class="accordion-title">
                                Strategy Sessions: Planning and Outlining Your Book</span>
                            <span class="accordion-sign"></span>
                        </label>
                        <div class="accordion-content">
                    ...
                    <div class="accordion-item">
                        ...
                        <label class="accordion-header" for="accordion5">
                            ...
                            <span class="accordion-title">
                                Let’s Write Your Manuscript</span>
                            <span class="accordion-sign"></span>
                        </label>
                        <div class="accordion-content">
                            ...
                            <br><br>
                            <b> Your Words. Your Voice. Our Pen.</b>
                            ...
                            <br><br>
                            <b> Ongoing Manuscript Review and Revisions</b>
        ...
        <div class="columns">
            ...
            <div class="wcu-right-col">
                ...
                <div class="row benefits-row-item">
                    ...
                    <p> <span style="color: #59D6E1;">Our team </span>of New York Times-bestselling ghostwriters and <br>
                        Big-5 acquisitions editors offers you the highest caliber of <br>
                        talent and professionalism.
                    </p>
                </div>

                <div class="row benefits-row-item">
                    <h2>Trust Former Publishing Executives</h2>

                    <p> Our Senior and Executive Editors are former acquisitions <br>
                        editors and editorial directors from the Big-5 publishing <br>
                        houses who have built and launched multiple #1 New York Times bestsellers.
                    </p>
                </div>
                ...
                <div class="row benefits-row-item">
                    ...
                    <p> We work directly with the industry’s top literary agents,<br>
                        publishers, hybrid presses, publicists, and book-<br>
                        marketing professionals — we’ll build and execute the<br>
                        optimal publishing strategy to achieve your goals.
                    </p>
                </div>
        ...
        <div class="columns reversed">
            ...
            <div class="wcu-right-col">
                <div class="row benefits-row-item2">
                    <h2>Low Time Commitment</h2>
                    <p>
                        Every author and every book is unique. We customize our <br> book editing and writing services to achieve your publishing <br> goals.
                    </p>
                </div>
                <div class="row benefits-row-item2">
                    <h2>Personalized Approach</h2>
                    <p>
                        Our team has decades of experience in executing effective <br> strategies for long-term success in publishing.
                    </p>
                </div>
                <div class="row benefits-row-item2">
                    <h2>Proven Process</h2>
                    <p>
                        Work with a team that has refined the art of successful book <br> writing and editing, leading to the publication of numerous <br> New York Times and national bestsellers.
                    </p>
                </div>
            </div>
        </div>
